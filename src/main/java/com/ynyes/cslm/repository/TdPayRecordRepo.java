        ...
        JpaSpecificationExecutor<TdPayRecord> 
{
    ...
    Page<TdPayRecord> findByUsernameAndTypeOrderByCreateTimeDesc(String username,Long type,Pageable page);
    
    Page<TdPayRecord> findByType(Long type,Pageable page);

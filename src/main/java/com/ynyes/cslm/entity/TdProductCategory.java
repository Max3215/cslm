...
public class TdProductCategory {
    ...
    // 关联标签    libiao
    @Column   
    private String tagValueCollect;
	...
	public String getTagValueCollect() {
		return tagValueCollect;
	}

	public void setTagValueCollect(String tagValueCollect) {
		this.tagValueCollect = tagValueCollect;
	}

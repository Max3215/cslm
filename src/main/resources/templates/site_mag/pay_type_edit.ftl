...
<div class="tab-content">
  ...
  <dl>
    <dt>描述说明</dt>
    <dd>
      <textarea name="info" rows="2" cols="20" class="input normal"><#if pay_type.info??>${pay_type.info}</#if></textarea>
  ...
  <dl>
    ...
    <dd>
      <textarea name="code" rows="2" cols="20" class="input normal"><#if pay_type.code??>${pay_type.code}</#if></textarea>
  ...
  <dl>
    <dt>活动标题</dt>
    <dd>
      <textarea name="tdTitle" rows="2" cols="20" class="input normal"><#if pay_type.info??>${pay_type.info}</#if></textarea>
  ...
  <dl>
    <dt>活动内容</dt>
    <dd>
      <textarea name="tdContents" rows="2" cols="20" class="input normal"><#if pay_type.info??>${pay_type.info}</#if></textarea>

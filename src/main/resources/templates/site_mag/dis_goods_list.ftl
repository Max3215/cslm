...
<ul style="width: 1189px;">
    ...
    <li style="margin-right: 15.75px;">
        <div class="details <#if !content.coverImageUri??>nopic</#if>">
            ...
            <div class="tools">
               <input type="text" style="border:none;color:skyblue;" value="${content.code!""}" readonly="readonly" >
            ...
            <div class="foot">
                ...
                <a href="/Verwalter/distributor/goods/edit?cid=${cid!""}&mid=${mid!""}&id=${content.id?c}&__VIEWSTATE=${__VIEWSTATE!""}" title="编辑" class="edit">编辑</a>

            ...
            <dd>
                <form action="/provider/edit/password" method="post" id="pas_form">
                    ...
                    <div style="margin-top: 14px;">
                        ...
                        <a href="/provider/retrieve_step1" style="margin-left:90px;">找回密码</a>
                    </div>
                    <div style="margin-top: 14px;">
                        <label>新密码：</label>
  ...
  <div class="mymember_center add_width">
    <div class="mymember_info mymember_info01 no_width">
      ...
      <table>
        ...
        <tr>
          <td>账户余额：¥${provider.virtualMoney?string('0.00')}</td>
          <td><a href="/provider/topup1" class="btn">充值</a></td>
          <td><a href="/provider/draw1" class="btn">提现</a></td>
        </tr>
      </table>
    </div>
    ...
    <div class="mymember_info mymember_info02">
      <menu class="buy_record">
        <a class="sel" href="/provider/pay/record">最近交易记录</a>
      </menu>
            ...
            <#if pay_record_page.totalPages gt 0>
                <#list 1..pay_record_page.totalPages as page>
                    <#if page <= 3 || (pay_record_page.totalPages-page) < 3 || (pay_record_page.number+1-page)?abs<3 >
                        ...
                        <#else>
                            <a href="/provider/account?page=${page-1}">${page}</a>
                        </#if>
                        <#assign continueEnter=false>
                    <#else>
                        <#if !continueEnter>

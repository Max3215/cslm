                ...
                <tr>
                  <td> <span style="position:absolute;right:88px;top:-13px;"><img src="/client/images/mymember/arrow06.gif"></span>
                          ...
                          <div class="mymember_eva_div">
                            ...
                            <input type="hidden" id="oldPrice" value="<#if turn.realPrice??>${turn.realPrice?string('0.00')}<#else>${turn.goodsPrice?string('0.00')}</#if>" />
                            <input style="line-height:26px;height:26px;border:1px solid #ccc;text-indent:4px;" id="realPrice" value="<#if turn.realPrice??>${turn.realPrice?string('0.00')}<#else>${turn.goodsPrice?string('0.00')}</#if>" />￥
                          </div>
                          <div class="mymember_eva_div">
                          ...
                          <div class="mymember_eva_div">
                            ...
                            <#if turn.statusId ==0>
                              <div class="mymember_eva_div">
                                <input class="mysub" type="submit" onclick="editReturn(${turn.id?c},1)" value="同意退货">
                                <input class="mysub change" type="submit" onclick="editReturn(${turn.id?c},2)" value="拒绝退货">
                              </div>
                              </#if>
                    </td>
                </tr>              

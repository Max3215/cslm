    ...
    <div class="mymember_info mymember_info01">
      <table>
        <tr>
          ...
          <td><a href="/supply/disOrder/list?statusId=2"><img src="/client/images/mymember/buy01.png" />待付款：<span>${total_unpayed!'0'}</span></a></td>
          <td><a href="/supply/disOrder/list?statusId=3"><img src="/client/images/mymember/buy02.png" />待发货：<span>${total_undelivered!'0'}</span></a></td>
        ...
        <tr>
          <td><a href="/supply/disOrder/list?statusId=4"><img src="/client/images/mymember/buy03.png" />待收货：<span>${total_unreceived!'0'}</span></a></td>
          <td><a href="/supply/disOrder/list?statusId=6"><img src="/client/images/mymember/buy04.png" />已完成：<span>${total_finished!'0'}</span></a></td>
        </tr>
      </table>
    </div>
    
    <div class="mymember_info mymember_info02">
      <h3>我的预购单<a href="/supply/disOrder/list">查看全部预购单</a></h3>
      <table width="100%"> 

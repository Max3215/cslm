      ...
      <div class="mymember_info mymember_info02">
	      <article class="essayamin">
            <#if info??>
                ...
                <#if prev_info??>
                    <p class="mb10">上一篇：<a href="/providerr/content/${prev_info.id?c}?mid=${mid}">${prev_info.title!''}</a></p>
                </#if>
                <#if next_info??>
                    <p>下一篇：<a href="/providerr/content/${next_info.id?c}?mid=${mid}">${next_info.title!''}</a></p>
                </#if>
                <div class="clear h20"></div>
            </#if>   
            </article>
